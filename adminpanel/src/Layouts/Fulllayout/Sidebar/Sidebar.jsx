...
function Deshboard(props) {
  ...
  const drawer = (
    <div>
      ...
      <List>
        <ListItem disablePadding onClick={()=>navigate("/Deshboard")}>
          <ListItemButton>
            <ListItemIcon>
              <WidgetsIcon />
            </ListItemIcon>
            <ListItemText>Deshboard</ListItemText>
          </ListItemButton>
        </ListItem>
        ...
        <ListItem disablePadding onClick={()=>navigate("/Coupon")}>
          <ListItemButton>
            <ListItemIcon>
              <CardGiftcardIcon />
            </ListItemIcon>
        ...
        <ListItem disablePadding onClick={()=>navigate("/Addon")}>
          <ListItemButton>
            <ListItemIcon>
              <QueueIcon />
            </ListItemIcon>
            <ListItemText>Addon</ListItemText>
          </ListItemButton>
        </ListItem>
